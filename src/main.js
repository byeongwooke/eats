...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (loadMoreBtn && menuContainer) {
    ...
    const getBrandFromFilename = (filename) => {
      if (filename.includes('파스타')) return '파스타히어';
      if (filename.includes('덮밥')) return '정담덮밥';
      if (filename.includes('오므라이스')) return '오므집';
      if (filename.includes('김치찜')) return '부여김치찜';
      return '이츠베럴';
    };

    const getCleanMenuName = (filename) => {
    ...
    loadMoreBtn.addEventListener('click', () => {
      extraMenus.forEach((filename, index) => {
        ...
        menuItem.innerHTML = `
          <div class="menu-card">
            ...
            <img src="menu/${filename}" alt="${menuName}">
      ...
      // Hide the load more button since all menus are loaded
  ...
  const officialMappings = {
    '파스타히어': ['별내 직영점','강북본점','노원본점','구리다산점','목천점','풍세점','의정부점','진접오남점','인천주안점','양주점','일산장항점','평내호평점','포천본점','청라연희점','월계공릉점','장안점','상봉점','화도마석점'],
    '정담덮밥': ['별내 직영점','강북본점','노원본점','구리다산점','목천점','풍세점','의정부점','진접오남점','인천주안점','양주점','일산장항점','평내호평점','포천본점','청라연희점','월계공릉점','장안점','상봉점','화도마석점'],
    '오므집': ['별내 직영점','노원본점','목천점','의정부점','진접오남점','인천주안점','양주점','평내호평점','포천본점','청라연희점','장안점','상봉점','화도마석점'],
    '부여김치찜': ['별내 직영점','강북본점','노원본점','목천점','의정부점','진접오남점','양주점','평내호평점','포천본점']
  };
  ...
  const renderMapBranches = (isInitial = false) => {
    ...
    allBranches.forEach(branch => {
      ...
      // 🎯 '부여 김치찜' 조건문 띄어쓰기 일치시켜 CSS 클래스 누락 해결
      const badgesHtml = branch.brands.map(b => {
        ...
        if (b === '부여 김치찜' || b === '부여김치찜') badgeClass = 'badge-kimchi'; // 띄어쓰기 유무 상관없이 모두 캐치
